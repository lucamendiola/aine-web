...
export const metadata: Metadata = {
  ...
  description:
    "Diagnosticamos y acompañamos 9 condiciones del neurodesarrollo: TEA, TDAH, Altas Capacidades, Síndrome de Down, retrasos del desarrollo, trastornos del aprendizaje, lenguaje, tics y problemás motores.",
  openGraph: {
    title: "Condiciones que atendemos | AINE",
    description:
      "Diagnosticamos y acompañamos 9 condiciones del neurodesarrollo en Monterrey.",
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto animate-fade-in-up">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-heading leading-tight mb-6">
              Cada mente es{" "}
              <span className="text-salmon">única y extraordinaria</span>
            </h1>
            ...
            <p className="text-lg sm:text-xl text-body leading-relaxed max-w-2xl mx-auto">
              ...
              diagnóstico preciso y acompañamiento integral para cada una. Conoce
              más sobre cada condición y cómo podemos ayudar.
            </p>
          </div>
        </div>
      </section>
