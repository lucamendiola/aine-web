...
export const metadata: Metadata = {
  title: "Nosotros",
  description:
    "Conoce al equipo de AINE: profesionales de salud dedicados al diagnostico y acompanamiento de ninos y jovenes con neurodivergencias en Monterrey.",
  openGraph: {
    title: "Nosotros | AINE",
    description:
      "El equipo transdisciplinario de AINE: pediatras, psicologos, terapeutas y mas en Monterrey.",
...
const team = [
  {
    name: "Dra. Maria Jose Delgado",
    role: "Pediatra",
    specialty: "Alta especialidad en Sindrome de Down",
    color: "#ff856c",
  },
  {
  ...
  {
    name: "Karina Picon",
    role: "Lic. en Enfermeria",
    specialty: "Encargada del centro",
    color: "#58b1f2",
  },
  {
    name: "Samira Velazquez",
    role: "Neuropsicologa",
    specialty: null,
    color: "#fba649",
  },
...
const boardMembers = [
  ...
  { name: "Luis Lauro Gonzalez", role: "Miembro" },
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto animate-fade-in-up">
            ...
            <p className="text-lg sm:text-xl text-body leading-relaxed max-w-2xl mx-auto">
              Un equipo de profesionales unidos por una mision: iluminar el camino
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <p className="mt-6 text-body text-lg leading-relaxed">
                En la mitologia gaelica, Aine es la diosa del verano, la riqueza y
                la soberania, asociada con el sol y el brillo. Elegimos este nombre
                porque refleja nuestra mision: ser la luz que guia a las familias en
              ...
              <p className="mt-4 text-body text-lg leading-relaxed">
                ...
                nino merece brillar con su propia luz. Nuestro trabajo es asegurar
                que tengan las herramientas y el acompanamiento para hacerlo.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 stagger-children">
            <div className="relative group">
              <div className="bg-white rounded-3xl p-8 h-full hover:shadow-xl hover:-translate-y-1 transition-brand border border-salmon/5">
                ...
                <h3 className="text-xl font-bold text-heading mb-3">Mision</h3>
                <p className="text-body leading-relaxed">
                  Diagnosticar y apoyar a ninos y jovenes con neurodivergencias
                  mediante una red integral y transdisciplinaria de profesionales
                  de salud, desde la infancia hasta los 18 anos.
                </p>
              </div>
            </div>
            ...
            <div className="relative group">
              <div className="bg-white rounded-3xl p-8 h-full hover:shadow-xl hover:-translate-y-1 transition-brand border border-salmon/5">
                ...
                <p className="text-body leading-relaxed">
                  Adaptarnos continuamente a avances cientificos y tecnologicos
            ...
            <div className="relative group">
              <div className="bg-white rounded-3xl p-8 h-full hover:shadow-xl hover:-translate-y-1 transition-brand border border-salmon/5">
                ...
                <h3 className="text-xl font-bold text-heading mb-3">Filosofia</h3>
                <p className="text-body leading-relaxed">
                  Cada nino es unico y extraordinario. No buscamos &ldquo;arreglar&rdquo;
                  a nadie, sino entender como funciona cada mente para potenciar
                  sus fortalezas y dar apoyo donde mas se necesita.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 sm:py-28 relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="mt-3 text-3xl sm:text-4xl font-extrabold text-heading">
              Quienes guian nuestra direccion
            </h2>
            <p className="mt-4 text-lg text-body max-w-2xl mx-auto">
              Un consejo comprometido con la mision de AINE y el bienestar de las
      ...
      <section className="py-20 sm:py-28 bg-cream relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h2 className="text-3xl sm:text-4xl font-extrabold text-heading mb-6">
            Detras de cada servicio hay un equipo{" "}
            <span className="text-salmon">que se preocupa.</span>
          </h2>
          <p className="text-lg text-body max-w-xl mx-auto mb-10">
            Si buscas atencion integral para tu hijo, estamos listos para
            acompanarte. Agenda una valoracion o escribenos por WhatsApp.
          </p>
