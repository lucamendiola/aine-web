...
export const metadata: Metadata = {
  title: "Servicios",
  description:
    "15 servicios especializados para ninos y jovenes con neurodivergencias. Diagnostico, terapias, neurologia pediatrica y mas bajo un mismo techo en Monterrey.",
  openGraph: {
    title: "Servicios | AINE",
    description:
      "Atencion integral con 15 servicios especializados para neurodivergencias en Monterrey.",
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
                ...
                <div className="absolute inset-0 flex items-center justify-center p-16">
                  <div className="text-center text-white">
                    ...
                    <p className="text-lg font-bold italic leading-relaxed">
                      &ldquo;No tratamos condiciones. Acompanamos personas
                      completas.&rdquo;
                    </p>
                  </div>
                </div>
            ...
            <div>
              ...
              <p className="mt-6 text-body text-lg leading-relaxed">
                ...
                nino es evaluado por un equipo que colabora y se comunica
                constantemente para crear un plan de intervencion unificado.
              </p>
              ...
              <div className="mt-8 space-y-6">
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="font-bold text-heading">Evaluacion integral</h3>
                    <p className="text-body text-sm mt-1">
                      Cada caso es revisado por multiples especialistas que cruzan
                      observaciones para un diagnostico preciso y completo.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="font-bold text-heading">Comunicacion continua</h3>
                    <p className="text-body text-sm mt-1">
                      Terapeutas, medicos y psicologos comparten avances y ajustan
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-body text-sm mt-1">
                      La asesoria a padres y las capacitaciones aseguran que el
      ...
      <section className="py-20 bg-salmon relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            {[
              { step: "01", title: "Contacto", desc: "Nos escribes por WhatsApp o llenas el formulario de valoracion." },
              { step: "02", title: "Valoracion", desc: "Nuestro equipo realiza una evaluacion integral de tu hijo." },
              { step: "03", title: "Plan de intervencion", desc: "Disenamos un plan personalizado con los servicios que necesita." },
              { step: "04", title: "Acompanamiento", desc: "Terapias, seguimiento y ajustes continuos hasta alcanzar los objetivos." },
            ].map((item) => (
      ...
      <section className="py-20 sm:py-28 bg-cream relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h2 className="text-3xl sm:text-4xl font-extrabold text-heading mb-6">
            Tu hijo merece atencion completa,{" "}
            <span className="text-salmon">no fragmentada.</span>
          </h2>
          <p className="text-lg text-body max-w-xl mx-auto mb-10">
            Agenda una valoracion con nuestro equipo transdisciplinario. El primer
